...
from deep_translator import GoogleTranslator #구글 번역

#번역 함수
def trans_ko(sentence):
...
summary = summarizer(
    ...
    max_length = 100,    # 최대토큰 수 => 길이 폭주 방지
...
#요약문 한국어 번역
kr_sum_text = trans_ko(sum_text)
print(f"번역된 문장 : {kr_sum_text}")
